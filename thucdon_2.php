...
<head>
  ...
  <link rel="shortcut icon" type="image/png" href="/Web/admin/product/uploads/avt0.png"/>
    ...
    <title>Danh mục bộ sưu tập</title>
    
</head>
<!-----------------------HEARDER ----------------------------------------->
<header>
        <img src="/Web/images/avt0.png" class="logo" style="width:130px;"><!--LOGO -->
        <div id="menu" style="margin-top:10px;">
                    <ul>
                        <li><a href="index.php">Cửa hàng</a></li><!--Trang chủ -->
                        <li>
                            <a href="#">Áo</a><!--Top -->
                            <ul class="sub-menu">
                        ...
                        <a href="#">Bộ sưu tập</a><!--Collection -->
                            <ul class="sub-menu">
                                <li><a href="thucdon_2.php?id_sanpham=1">Quần áo phổ biến</a></li>
                                <li><a href="thucdon_2.php?id_sanpham=2">Xu hướng thời trang</a></li>
                                <li><a href="thucdon_2.php?id_sanpham=3">Kiến thức thời trang</a></li>
                            </ul>
                        </li>
                        <li><a href="AboutUs/AboutUs.php">Về chúng tôi</a></li><!--About us -->
                    </ul>
                </div>
...
background-image :url("banner hodie.png");
