...
<section class="main">
    ...
    <!--------------------BannerTHỜI TRANG THU ĐÔNG--------------------------- -->
    <div id="banner2"><!--banner2 baneer-->
        <div class="box-left">
            <h2>
    ...
    <!--------------------BANNER--------------------------- -->
    <div id="banner3"><!--banner3 banner picnic  -->
        <div class="box-left">
    ...
    <!--------------------WHAT'S HOT--------------------------- -->
    <div id="new">
        <h2> THỜI TRANG THỊNH HÀNH </h2>
        <ul id="list-new">
            <div class="item"><!--sản phẩm 1 -->
                <img src="/Web/images/new6.jpg" width="340" height="340" alt="">
            ...
            <div class="item"><!--sản phẩm 2 -->
                <img src="/Web/images/new7.jpg" width="340" height="340" alt="">
                <div class="name">NHỮNG MÀU SẮC XU HƯỚNG CHO THỜI TRANG THU ĐÔNG</div>
            ...
            <div class="item"><!--sản phẩm 1 -->
                <img src="/Web/images/new8.jpg" width="340" height="340" alt="">
    ...
    <style>
        ...
        * {
        ...
        #banner1 {
            ...
            background-image: url("/Web/images/banner main.png");
        ...
        #banner2 {
            /* banner rồng*/
            width: 100%;
            background-image: url("/Web/images/banner picnic.jpg");
        ...
        #banner3 {
            /* banner lilywuyn*/
            width: 100%;
            background-image: url("/Web/images/banner modul.jpg");
            background-size: cover;
            height: 700px;
            /*chỉnh size banner*/
            margin-top: -40px;
